  ...
  return (
    <div 
      className={twMerge(
        ...
        "pointer-events-none absolute left-1/2 top-1/4 md:top-1/2 h-[300px] w-[300px] -translate-x-[80%] -translate-y-1/2 rounded-full blur-[80px] md:h-[600px] md:w-[800px] md:blur-[130px] opacity-40",
